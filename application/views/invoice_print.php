            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Order Invoice</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            <h3>To,</h3>
                                            <h4 class="font-bold"><?php echo $order_data['customer_name']; ?></h4>
                                            <p class="text-muted m-l-30"><?php echo $order_data['customer_address']; ?></p>
                                            <?php 
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        ...
                                        <p>IGST (<?php echo $order_data['igst_rate']; ?>%) : <?php echo $order_data['igst']; ?> </p>
                                        <p>Discount : <?php echo $order_data['discount']; ?> </p>
                                        <hr>
