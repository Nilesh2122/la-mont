...
footer {
  ...
  <body>
    <header class="clearfix">
      ...
      <div id="project">
        <h3>To,</h3>
        <div><span>CLIENT</span>'.$order_data['customer_name'].'</div>
        <div><span>ADDRESS</span>'.$order_data['customer_address'].'</div>
    ...
    <main>
      <table>
        ...
        <tbody>';
          ...
          <tr>
            <td colspan="4">CGST ('.$order_data['cgst_rate'].'%) </td>
            <td class="total">'.$order_data['cgst'].'</td>
          </tr>
          <tr>
            <td colspan="4">SGST ('.$order_data['sgst_rate'].'%) </td>
            <td class="total">'.$order_data['sgst'].'</td>
          </tr>
          <tr>
            <td colspan="4">IGST ('.$order_data['igst_rate'].'%) </td>
            <td class="total">'.$order_data['igst'].'</td>
          </tr>
          <tr>
            <td colspan="4">Discount </td>
            <td class="total">'.$order_data['discount'].'</td>
          </tr>
          <tr>
...
file_put_contents( 'assets/customer_bill/'.$order_data['bill_no'].'.pdf', $output );
