...
function getTotal(row = null) 
{
  ...
  $.ajax({
      type: "POST",
      dataType : "json",
      url: base_url + 'Order/fetch_product_qty',    
...
function getProductData(row_id)
{
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'Order/getProductValueById',
        type: 'post',
...
$('#add_order').on('submit', function(e)
{
    e.preventDefault();
    $.ajax({
        url: base_url+"Order/order_process", 
        method:"POST",
        dataType : "json",
            ...
            if(json.status_code == '1')
            {
                ...
                }).then(function(isConfirm) 
                {
                  if (isConfirm) 
                  {
                     ...
                     window.location.href = base_url+"Order/GeneratePdf/"+json.data;
                  }
                });
            }
            else
