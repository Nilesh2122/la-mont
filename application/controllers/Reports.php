...
class Reports extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('manage_reports');
		$this->load->view('footer');
	}
	public function products()
	{
		$result['product'] = $this->ModelReports->get_products_report();
		$this->load->view('header');
		$this->load->view('product_reports_superadmin',$result);
		$this->load->view('footer');
     /*$productResult=$this->ModelReports->get_products_report();
	...
	{
     $productResult = $this->ModelReports->get_warehouses_report();
