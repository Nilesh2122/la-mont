...
class Order extends CI_Controller {
	...
	{
		//$result['order'] = $this->ModelOrder->getOrdersData();
		$result['order'] = $this->ModelOrder->get_order_data();
		/*echo "<pre>";
    	print_r($result);
    	echo "</pre>";
    	exit();*/
		$this->load->view('header');
		$this->load->view('manage_order',$result);
		$this->load->view('footer');
	}
	public function addorder()
	{
		$company = $this->ModelOrder->getCompanyData(1);
	...
	{
		$response_data = $this->ModelOrder->order_process();
	...
	{
		$result['order_data'] = $this->ModelOrder->getOrdersData($id);
		$result['orders_items'] = $this->ModelOrder->order_item_data($id);
	...
	{
		$this->data['returns'] = $this->ModelOrder->manage_store_return();
		/*echo "<pre>";
    	print_r($this->data);
    	echo "</pre>";
    	exit();*/
	...
	public function add_return_order_admin()
	{
		$this->data['products'] = $this->ModelOrder->manage_product_all();
		$this->load->view('header');
		$this->load->view('retun_admin_order',$this->data);
		$this->load->view('footer');	
	}
	public function admin_returns()
	{
        $response_data = $this->ModelOrder->store_returns();
		echo json_encode($response_data);
	}
